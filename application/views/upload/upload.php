                            ...
                            <div class="input field">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                                        <input type="text" name="full_name" id="" value='<?= set_value('full_name') ?>' placeholder="Họ tên" style="padding-left: 5px; font-size: 17px; width: 92%; margin-left: 50px; height: 44px">
                                        <?form_error('full_name')?>
                                    </div>

                                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6" style="text-align: right">
                                        <input type="text" name="birthday" id="" value='<?= set_value('birthday') ?>' placeholder="Ngày sinh" style="padding-left: 5px; font-size: 17px; width: 92%; margin-right: 50px; height: 44px">
                                        <?form_error('birthday'); ?>
                                    </div>
                                ...
                                <div class="row" style="margin-top: 25px">
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                                        <input type="text" name="phone" id="" value='<?= set_value('phone') ?>' placeholder="Số điện thoại" style="padding-left: 5px; font-size: 17px; width: 92%; margin-left: 50px; height: 44px">
                                        <?form_error('phone'); ?>
                                    </div>

                                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6" style="text-align: right">
                                        <input type="text" name="email" id="" value='<?= set_value('email') ?>' placeholder="Email" style="padding-left: 5px; font-size: 17px; width: 92%; margin-right: 50px; height: 44px">
                                        <?echo form_error('email'); ?>
                                    </div>

                                </div>

                                <input type="file" name="picture" id="file_info" value='<?= set_value('note') ?>' class="custom-file-input" style="margin-top: 25px; margin-left: 240px;"><p style="color: red"><?=!empty($errors)?$errors:''?></p>
