...
class Landing_Page_Vna extends CI_Controller
{
        ...
        if($action == 'save') {
            ...
            if ($this->form_validation->run()) {
                ...
                $oauth_user = array(
                    ...
                    'full_name' => $data_submit['first_name'] . ' ' . $data_submit['last_name'] ,
    ...
    {
    	return (preg_match('/^[a-zA-Z0-9_\.]{1,32}@[a-z0-9]{2,}(\.[a-z0-9]{2,4})$/', $email));
	}

    private function is_phone($phone)
    {
		return preg_match('/^(9\d{8}|8\d{8}|7\d{8}|3\d{8}|5\d{8})$/', $phone);
    }
